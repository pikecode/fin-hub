...
export interface StoreLedgerWorkspaceMetrics {
  ...
  fee_amount: string;
  income_year_over_year: string | null;
  income_month_over_month: string | null;
  approval_amount: string;
  approval_accounting_amount: string;
  labor_cost_amount: string;
  rent_cost_amount: string;
  operation_expense_amount: string;
  food_cost_rate: string | null;
  labor_cost_rate: string | null;
  rent_cost_rate: string | null;
  operation_expense_rate: string | null;
  chicken_cost_amount: string;
  mushroom_cost_amount: string;
  chicken_cost_rate: string | null;
  mushroom_cost_rate: string | null;
